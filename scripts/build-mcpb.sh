  ...
  cat > "$WORK/manifest.json" <<EOF
{
  ...
  "tools": [
    { "name": "get_server_info", "description": "Show server version, mode, Kubernetes config source, and runtime details" },
    { "name": "resolve_workload", "description": "Resolve an app/workload name to matching resources and suggested next tools" },
    { "name": "list_pods", "description": "List pods; supports all_namespaces=true" },
    { "name": "get_pod", "description": "Get detailed pod information" },
    { "name": "get_pod_logs", "description": "Get pod logs" },
    { "name": "list_deployments", "description": "List deployments; supports all_namespaces=true" },
    { "name": "get_deployment", "description": "Get deployment details" },
    { "name": "list_statefulsets", "description": "List StatefulSets; supports all_namespaces=true" },
    { "name": "get_statefulset", "description": "Get StatefulSet details" },
    { "name": "list_services", "description": "List services; supports all_namespaces=true" },
    { "name": "get_service", "description": "Get service details" },
    { "name": "list_configmaps", "description": "List ConfigMaps; supports all_namespaces=true" },
    { "name": "get_configmap", "description": "Get ConfigMap data" },
    { "name": "list_secrets", "description": "List Secrets (keys only); supports all_namespaces=true" },
    { "name": "get_secret", "description": "Get Secret metadata and keys" },
    { "name": "list_pvc", "description": "List PersistentVolumeClaims; supports all_namespaces=true" },
    { "name": "list_ingress", "description": "List Ingress resources; supports all_namespaces=true" },
    { "name": "list_jobs", "description": "List Jobs; supports all_namespaces=true" },
    ...
    { "name": "get_cluster_overview", "description": "Get cluster health summary" },
    ...
    { "name": "get_rollout_status", "description": "Check rollout status [readwrite]" },
